...
object ReminderNotificationManager {
    const val CHANNEL_ID = "ebbinghaus_reminders_channel"
    ...
    fun createNotificationChannel(context: Context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Уведомления о карточках, подошедших к сроку повторения"
    ...
    fun showReminderNotification(context: Context, overdueCount: Int) {
